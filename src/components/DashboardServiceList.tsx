...
/**
 * Narrow-layout dashboard body: the service list windowed to the measured body
 * height. Reads the viewport from `FullscreenLayout` instead of any `chromeRows`
 * arithmetic — the height is whatever the flexbox layout leaves between the fixed
 * header and footer, so the list can never overflow and blank the pane (the v1
 * bug). The wide layout (list + detail pane split) lives in {@link DashboardSplit}.
 *
